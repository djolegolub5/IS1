...
CREATE TABLE `recenzija` (
  ...
  PRIMARY KEY (`IdRec`),
  UNIQUE KEY `IdRec_UNIQUE` (`IdRec`),
  KEY `IdKor_idx` (`IdKor`,`IdArt`),
  CONSTRAINT `IdKorArt` FOREIGN KEY (`IdKor`, `IdArt`) REFERENCES `prodaje` (`IdKor`, `IdArt`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `recenzija` VALUES (1,1,1,4,'Vrlo dobar proizvod'),(2,2,3,5,'Odlican proizvod'),(3,3,5,1,'Uzasan proizvod'),(4,5,7,2,'Nit smrdi nit mirise');
