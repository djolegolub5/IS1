...
CREATE TABLE `prodaje` (
  ...
  KEY `IdArtPro` (`IdArt`),
  CONSTRAINT `IdArtPro` FOREIGN KEY (`IdArt`) REFERENCES `artikal` (`IdArt`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `IdKorPro` FOREIGN KEY (`IdKor`) REFERENCES `korisnik` (`IdKor`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `prodaje` VALUES (1,1),(1,2),(2,3),(2,4),(3,5),(4,6),(5,7),(6,8);
